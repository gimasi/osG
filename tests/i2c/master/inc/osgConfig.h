...
/// @{
#define OSG_USE_I2C0_AF         0 //kPORT_MuxAlt2
#define OSG_USE_I2C1_AF         0 //GPIO_AF4_I2C1
...
#if (MCU_NAME == STM32_L4)
    #include "stm32l4xx_hal_gpio_ex.h"
#elif (MCU_NAME == STM32_L0)
    #include "stm32l0xx_hal_gpio_ex.h"
#elif (MCU_NAME == NXP_MK28F)
    #include "fsl_port.h"
#endif
