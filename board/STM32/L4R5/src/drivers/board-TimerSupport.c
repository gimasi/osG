...
{
    uint8_t index = _osg_board_Timer_getTimerIndex(TIM1);
    if (_osg_board_Timer_timers[index].flags & OSG_TIMER_FLAG_IN_USE)
        HAL_TIM_IRQHandler(&_osg_board_Timer_timers[index].tim_handler);

    index = _osg_board_Timer_getTimerIndex(TIM16);
    if (_osg_board_Timer_timers[index].flags & OSG_TIMER_FLAG_IN_USE)
        HAL_TIM_IRQHandler(&_osg_board_Timer_timers[index].tim_handler);
}
...
{
    uint8_t index = _osg_board_Timer_getTimerIndex(TIM4);
    HAL_TIM_IRQHandler(&_osg_board_Timer_timers[index].tim_handler);
}
void TIM5_IRQHandler(void)
{
    uint8_t index = _osg_board_Timer_getTimerIndex(TIM5);
    HAL_TIM_IRQHandler(&_osg_board_Timer_timers[index].tim_handler);
}
...
//{
//    uint8_t index = _osg_board_Timer_getTimerIndex(TIM8);
//    HAL_TIM_IRQHandler(&_osg_board_Timer_timers[index].tim_handler);
//}
...
{
    uint8_t index = _osg_board_Timer_getTimerIndex(TIM15);
    HAL_TIM_IRQHandler(&_osg_board_Timer_timers[index].tim_handler);
}
void TIM1_TRG_COM_TIM17_IRQHandler(void)
{
    uint8_t index = _osg_board_Timer_getTimerIndex(TIM17);
    HAL_TIM_IRQHandler(&_osg_board_Timer_timers[index].tim_handler);
}
