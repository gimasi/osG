...
#define TOT_UART (COUNT_UART0 + COUNT_UART1 + COUNT_UART2 + COUNT_UART3 + COUNT_UART4 + COUNT_UART5)
...
#endif
#ifdef USART4
        case OSG_UART4: return OSG_USART;
#endif
#ifdef USART5
        case OSG_UART5: return OSG_USART;
#endif
...
#endif
#ifdef USART4
        case OSG_UART4: __HAL_RCC_USART4_CLK_DISABLE(); break;
#endif
#ifdef USART5
        case OSG_UART5: __HAL_RCC_USART5_CLK_DISABLE(); break;
#endif
        default:
            osg_error("ERROR: Invalid UART Port in UART reset.");
    }
...
#endif
#ifdef USART4
        case OSG_UART4: HAL_NVIC_DisableIRQ(USART4_5_IRQn); break;
#endif
#ifdef USART5
        case OSG_UART5: HAL_NVIC_DisableIRQ(USART4_5_IRQn); break;
#endif
        default:
            osg_error("ERROR: Invalid UART Port in UART reset.");
    }
...
void UART4_5_IRQHandler(void)
{
    uint8_t index = _osg_board_Uart_getDeviceIndex(OSG_UART4);
    HAL_UART_IRQHandler(&_osg_board_Uart_handlers[index]);
    
    index = _osg_board_Uart_getDeviceIndex(OSG_UART5);
    HAL_UART_IRQHandler(&_osg_board_Uart_handlers[index]);
}
#endif
